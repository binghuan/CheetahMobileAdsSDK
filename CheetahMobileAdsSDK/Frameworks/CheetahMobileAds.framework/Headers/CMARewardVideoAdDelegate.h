...
- (void)rewardVideoWillShowAd:(CMARewardVideoAd *)rewardVideoAd;

- (void)rewardVideoAd:(CMARewardVideoAd *)rewardVideoAd didFailShowAdWithError:(CMARequestError *)error;

- (void)rewardVideoDidShowAd:(CMARewardVideoAd *)rewardVideoAd;
